...
const Footer = () => {
  ...
  const contactScriptURL =
    "https://script.google.com/macros/s/AKfycbwkteK4H-w5MGu4RLl74k57NVL_84P1Jx9PgRL4OoXNEFzE64T1FrTuuecZ19peV2CN6w/exec";
      ...
      <div className="footer-container">
        <div className="footer-cont">
          <div className="footer-left-pane">
            ...
            <i>    <a
              href="mailto:info@emm-services.co.za">
              <img src={email}>
              </img>
              <ul>
                <li>info@emm-services.co.za</li>
              </ul>
            </a>
            </i>
            <i><img src={phone}>
